...
interrupt_RBX_t RB_obj_1 = {
  .EXT_InterruptHandler_LOW = ((void*)0),
...
int main() {
     ...
     for(int i = 0; i < 4; i++)
      ...
      while(1){
          ...
          for(uint8 cnt_row = 0; cnt_row < 4; cnt_row++){
            for(cnt = 0; cnt < 4; cnt++)
            {
          ...
          send_4_bit_command(&lcd_4bit,0x0D);
          if(4 == cnt_pw && 0 == psw_st)
          {
            send_4_bit_command(&lcd_4bit,0x0C);
