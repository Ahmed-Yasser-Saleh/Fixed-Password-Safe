...
# 31 "MCAL_layer/Interrupt/interrupt_manager.c"
void __attribute__((picinterrupt(("")))) InterruptManager(void){

 if((0x01 == INTCONbits.INT0E) && (0x01 == INTCONbits.INT0F)){
        INT0_ISR();
    }
    else{ }
    if((0x01 == INTCON3bits.INT1E) && (0x01 == INTCON3bits.INT1F)){
        INT1_ISR();
    }
    else{ }
    if((0x01 == INTCON3bits.INT2E) && (0x01 == INTCON3bits.INT2F)){
        INT2_ISR();
    }
    else{ }
